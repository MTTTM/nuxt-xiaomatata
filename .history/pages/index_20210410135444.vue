    ...
    <b-container>
      <b-row class="w-100" no-gutters>
            ...
            <b-row no-gutters>
              <b-col md="3">
                <b-card-img
                  ...
                  alt="Image"
                  class="rounded-0 cart-list-item-img"
                ></b-card-img>
              </b-col>
              <b-col md="9">
        ...
        <b-col lg="3" md="12" sm="12" class="cm-sm-hide">
          <b-card no-body>
            <template #header>
              <h4 class="mb-0">热文推荐</h4>
            </template>

            <b-card-body>
              <b-card-text>
                <a href="#" class="card-link"
                  >你好阿斯蒂芬，污泥起舞污泥起舞污泥起舞</a
                >
              </b-card-text>
              <b-card-text>
          ...
          <b-card no-body style="margin-top: 1rem">
            <template #header>
              <h4 class="mb-0">最新评论</h4>
            </template>

            <b-card-body>
              <a href="#">
                <b-card-sub-title class="mb-2"
                  >评论:html新特性</b-card-sub-title
                >
                <b-card-text>
                  吧啦啦啦，污泥起舞阿凡达。吧啦啦啦，污泥起舞阿凡达
                </b-card-text>
              </a>
              <a href="#">
                <b-card-sub-title class="mb-2"
          ...
          <b-card no-body style="margin-top: 1rem">
            ...
            <b-list-group flush>
              <b-list-group-item class="d-flex align-items-center">
                ...
                <b-badge variant="danger">1000</b-badge>
              </b-list-group-item>
              <b-list-group-item class="d-flex align-items-center">
                <b-avatar class="mr-3"></b-avatar>
                <span class="mr-auto">J. Circlehead</span>
                <b-badge variant="warning">500</b-badge>
              </b-list-group-item>
              <b-list-group-item class="d-flex align-items-center">
                <b-avatar class="mr-3"></b-avatar>
                <span class="mr-auto">J. Circlehead</span>
                <b-badge variant="info">500</b-badge>
              </b-list-group-item>
              <b-list-group-item class="d-flex align-items-center">
                <b-avatar class="mr-3"></b-avatar>
                <span class="mr-auto">J. Circlehead</span>
                <b-badge variant="success">500</b-badge>
              </b-list-group-item>
              <b-list-group-item class="d-flex align-items-center">
                <b-avatar class="mr-3"></b-avatar>
                <span class="mr-auto">J. Circlehead</span>
                <b-badge variant="dark">500</b-badge>
              </b-list-group-item>
            </b-list-group>
          </b-card>
          <b-card-group deck style="margin-top: 1rem">
            <b-card title="关于塔塔" header-tag="header">
              <template #header>
                <h4 class="mb-0">关于塔塔</h4>
              </template>
              <b-card-text>备案号：暂无 xx xx</b-card-text>
              <b-card-text>备案号：暂无 xx xx</b-card-text>
            </b-card>
          </b-card-group>
        </b-col>
